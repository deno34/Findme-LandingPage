        ...
        <footer className="border-t border-border/20 bg-background/80 backdrop-blur-sm">
            <div className="container mx-auto px-4 py-8 text-center text-muted-foreground">
                <div className="space-y-4">
                    <p>&copy; {new Date().getFullYear()} Findme Messenger, a subsidiary of Trapslash Inc. All rights reserved.</p>
                    <div className="text-sm max-w-2xl mx-auto">
                        <p className="font-semibold text-foreground/80 mb-1">From the creators of Findme Messenger:</p>
                        <p>
